...
//state -- request params from clnt mapped to Java bean properties
	...
	private String fn;
	private String ln;
	private String dob;// dob : strig since WC can not translate
						// non primitive 
	...
	public String validateUser() throws SQLException {
		...
		if (userDetails == null) {
			...
			return "login"; // bean returns navigational outcome to JSP(tells JSP, where to take the clnt
							// next)
		}
	...
	//add B.L. method for validating i/p's n then registration
	public String validateAndRegister()
	{
		...
		//in case invalid age -- retns err mesg
		if(ageInYears < 21)
			return "invalid age";
		//valid age, create User(voter) instance
		User voter = new User(fn, ln, email, password, birthDate.toString());
			
		//o.w. invoke dao's method for reg
		System.out.println("in registration method of userBean");
		}
